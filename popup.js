...
$(document).ready(function() {
   ...
   $("tr[class*='ligne'] td:nth-child(" + indexThFichier + ")").each(function() {
	  ...
	  if (titre) {
		  ...
		  var liens = '<form style="display:inline;" action="http://binsearch.info/" method="get" target="_blank"><input type="hidden" name="q" value="' + titre + '"><a onClick="$(this).parent().submit();" class="c16" href="#">' + titre + '</a></form>';
		  liens += '&nbsp;';
